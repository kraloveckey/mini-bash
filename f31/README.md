...
```bash
root@kali:~$ git clone https://github.com/kraloveckey/mini-bash
root@kali:~$ cd mini-bash/f31/
root@kali:~/mini-bash/f31$ chmod +x f31.sh reset.sh
```
> f31 requires root privileges to run

```bash
root@kali:~$ sudo bash f31.sh
███████ ██████   ██ 
██           ██ ███ 
█████    █████   ██ 
██           ██  ██ 
...
Version: 1.0.0
echo "For instructions and an example of how to use it, visit: https://github.com/kraloveckey/mini-bash/f31"
...
```bash
root@kali:~/mini-bash/f31$ sudo bash f31.sh --interface eth0 --new-hostname ubuntu --noise-reduction
███████ ██████   ██ 
██           ██ ███ 
█████    █████   ██ 
██           ██  ██ 
...
```bash
root@kali:~/mini-bash/f31$ sudo bash reset.sh --interface eth0 --old-hostname kali
███████ ██████   ██ 
██           ██ ███ 
█████    █████   ██ 
██           ██  ██ 
